...
public class AreaServiceImpl implements AreaService {
    ...
    public String reportstatistics(String companyName, String fulfill) {
        ...
        String sql="select t.*,b.zccl,CONCAT(ROUND(nvl(b.zccl,0)*100/t.clzs,2),'%') hccgl,(t.clzs-b.zccl) yccl from (select count(distinct v.PLATE_NUMBER) clzs,v.company_name from tb_global_vehicle@db69 v,tb_area_company@db69 c" +
